...
//
//class OldMailingControllerTest {
...
//
//        String request = "" +
//                "GET /blg_kotik_dmitry_war/mailing/ HTTP/1.1\n" +
...
//
//        String request = "" +
//                "GET /blg_kotik_dmitry_war/mailing?email=test@mail.ru HTTP/1.1\n" +
//                "Accept: application/json, */*; q=0.01\n" +
//                "Content-Type: application/json\n" +
//                "Host: 127.0.0.1:8080\n" +
//                "UnitTest: true\n" +
...
//
//        String request = "" +
//                "GET /blg_kotik_dmitry_war/mailing/1/ HTTP/1.1\n" +
//                "Accept: application/json, */*; q=0.01\n" +
//                "Content-Type: application/json\n" +
//                "Host: 127.0.0.1:8080\n" +
//                "UnitTest: true\n" +
...
//
//        String request = "" +
//                "DELETE /blg_kotik_dmitry_war/mailing/1/ HTTP/1.1\n" +
//                "Accept: application/json, */*; q=0.01\n" +
//                "Content-Type: application/json\n" +
//                "Host: 127.0.0.1:8080\n" +
//                "UnitTest: true\n" +
