...
@WebServlet(name="CommentServlet", urlPatterns={"/comment/*", "/comment/"})
public class CommentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            CommentController commentController = context.getBean("commentController", CommentController.class);
            HttpResponse customHttpResponse = commentController.getResponse();
            commentController.buildResponse(customHttpRequest);
