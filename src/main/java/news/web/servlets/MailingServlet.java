...
@WebServlet(name="MailingServlet", urlPatterns={"/mailing/*", "/mailing/"})
public class MailingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            MailingController mailingController = context.getBean("mailingController", MailingController.class);
